...
def compute_metrics(pred):
    ...
    metrics = {
        ...
        'eval_proposal_f1': proposal_f1,
        'eval_proposal_precision': proposal_precision,
        'eval_proposal_recall': proposal_recall,
        'eval_category_accuracy': category_acc,
        'eval_category_f1': category_f1,
        'eval_category_precision': category_precision,
        'eval_category_recall': category_recall,
